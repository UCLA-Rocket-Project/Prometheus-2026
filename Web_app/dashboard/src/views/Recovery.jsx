...
export default function Recovery({ latest, history, padCoords }) {
  ...
  const milestones = useMemo(() => {
    ...
    return [
      ...
      { label: 'Drogue descent rate: 75 ft/s', time: null, color: '#e3b341', done: pi >= 4 && latest?.rec_drogue === 1 },
      ...
      { label: 'Main descent rate: 24.5 ft/s', time: null, color: '#3fb950', done: pi >= 5 && latest?.rec_main === 1 },
