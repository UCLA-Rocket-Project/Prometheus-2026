...
7. connect mosquitto server host (your computer) to WiFi router. You can find username and password information in code (ssid is username, psasword is the password)
